...
import { Loading, Empty, Failure, Success } from './QualityCell'
...
describe('QualityCell', () => {
  ...
  it('Success renders successfully', () => {
    render(<Success userExample={{ quality: { objectKey: 'objectValue' } }} />)
    expect(
      screen.queryByText('{"quality":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})
